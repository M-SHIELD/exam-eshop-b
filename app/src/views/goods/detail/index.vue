  ...
  data() {
    return {
      ...
      goods: {
        isCollect: false,
        // 默认商品 sku 缩略图
        pic_urls: ['https://oss.xiaomao6.com/mkoss/2022/02/27/940dd6c1.png',
          'https://oss.xiaomao6.com/mkoss/2022/02/27/c49cce16.png'],//轮播图列表
        picture: 'https://oss.xiaomao6.com/mkoss/2022/02/27/c49cce16.png',//商品头图
        name: '测试商品',//名称
        subtitle: '标题',//副标题
              ...
              v: [
                {
                  ...
                  imgUrl: 'https://oss.xiaomao6.com/mkoss/2022/02/27/dbd8f3db.png', // 规格类目图片，只有第一个规格类目可以定义图片
                  previewImgUrl: 'https://oss.xiaomao6.com/mkoss/2022/02/27/dbd8f3db.png', // 用于预览显示的规格类目图片
                },
                {
                  id: '2',
                  name: '蓝色',
                  imgUrl: 'https://oss.xiaomao6.com/mkoss/2022/02/27/09e8bcb8.png',
                  previewImgUrl: 'https://oss.xiaomao6.com/mkoss/2022/02/27/09e8bcb8.png',
                }
              ],
