...
insert  into `e_order`(`id`,`order_no`,`uid`,`shop_id`,`total_amount`,`pay_amount`,`pay_type`,`status`,`create_time`,`update_time`,`is_del`) values (1,'202204100001',1,1,'199.99','199.99',1,1,'2022-04-10 10:00:00','2022-04-10 10:00:00',0),(2,'202204110001',1,1,'399.99','399.99',2,1,'2022-04-11 10:00:00','2022-04-11 10:00:00',0),(3,'202204120001',1,2,'599.99','599.99',1,2,'2022-04-12 10:00:00','2022-04-12 10:00:00',0),(4,'202204130001',1,2,'799.99','799.99',2,3,'2022-04-13 10:00:00','2022-04-13 10:00:00',0),(5,'202204140001',1,2,'999.99','999.99',1,4,'2022-04-14 10:00:00','2022-04-14 10:00:00',0);
...
CREATE TABLE `e_product` (
  ...
  `slider_image` varchar(1000) DEFAULT NULL COMMENT '商品预览图片',
  ...
  `integral` decimal(11,0) DEFAULT NULL COMMENT '所需积分',
...
insert  into `e_product`(`id`,`name`,`shop_id`,`category_id`,`image`,`slider_image`,`description`,`price`,`stock`,`sales`,`is_show`,`is_hot`,`is_integral`,`integral`,`status`,`create_time`,`update_time`,`is_del`) values (1,'Apple iPhone 12 Pro Max',1,1,NULL,NULL,'iPhone 12 Pro Max 搭载了 5 纳米 A14 Bionic 芯片，性能比上一代更加出色，同时也拥有强大的摄像头和更好的显示效果。','1099.00',100,50,1,0,0,NULL,1,'2022-04-10 10:00:00','2022-04-10 10:00:00',0),(2,'Samsung Galaxy S21 Ultra',2,1,NULL,NULL,'Galaxy S21 Ultra 拥有 6.8 英寸的 AMOLED 显示屏、Exynos 2100 处理器以及 108MP 主摄像头等功能，同时还支持 5G 网络。','899.00',200,80,1,0,0,NULL,1,'2022-04-11 10:00:00','2022-04-11 10:00:00',0),(3,'Sony PlayStation 5',1,2,NULL,NULL,'PlayStation 5 是索尼游戏机的最新一代，采用了全新的定制处理器和高速固态硬盘，带来更加流畅的游戏体验。','499.00',50,20,1,0,0,NULL,1,'2022-04-12 10:00:00','2022-04-12 10:00:00',0);
